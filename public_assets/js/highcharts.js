...
(function(L, a) {
    ...
    (function(a) {
        ...
        D.prototype = {
            ...
            textSetter: function(a) {
                a !== this.textStr && (delete this.bBox, this.textStr = (a+'').getDigitBanglaFromEnglish(), this.added && this.renderer.buildText(this))
                //console.log('t '+a.getDigitBanglaFromEnglish());
            },
    ...
    (function(a) {
        ...
        var C = a.color,
            ...
            p = a.win;
        a.defaultOptions = {
            colors: "#337ab7 #5cb85c #e4d354 #f15c80 #5a1de0 #f7a35c #8085e9 #2b908f #f45b5b #91e8e1".split(" "),
