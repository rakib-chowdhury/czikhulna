...
$db['pisqr']['username'] = 'root';//'root';//
$db['pisqr']['password'] = '';//'';//
$db['pisqr']['database'] = 'inkhulna_somobay';//'inkhulna_somobay';//
$db['pisqr']['dbdriver'] = 'mysql';
$db['pisqr']['dbprefix'] = '';
...
$db['pi']['username'] = 'inkhulna_user';//'root';
$db['pi']['password'] = 'user123';//'';
$db['pi']['database'] = 'inkhulna_somobay';'somobay';
