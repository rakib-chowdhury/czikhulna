    ...
    <div id="content">
        <form onsubmit="return idea_ckeck()" action="<?= site_url('home/idea_box_post') ?>" method="post">
            ...
            <div class="page-banner about-banner">
                <div class="container">
                    <ul class="page-tree">
                        ...
                        <li><a href="<?= site_url('home/idea_box') ?>">মতামত</a></li>
                    </ul>
                </div>
            </div>

            <h1 class="page-title about-title"><span style="color: whitesmoke; background: #8bc541;">মতামত</span></h1>
                    ...
                    <div class="row">
                            ...
                            <div class="accordion-box triggerAnimation animated" data-animate="fadeInLeft">
                                <div class="row" style="margin-right: 5px;">
                                    <div class="form-group">
                                        <label for=""><span
                                            style="color: red; font-size: 16px;">* </span>নাম</label>
                                    ...
                                    <div class="form-group">
                                        <label for="mb"><span
                                            style="color: red; font-size: 16px;">* </span>মোবাইল নম্বর</label>
                                    ...
                                    <div class="form-group">
                                        <label for=""><span
                                            style="color: red; font-size: 16px;">* </span>জাতীয় পরিচয়পত্র নম্বর</label>
                                    ...
                                    <div class="form-group">
                                        <label for="email"><span
                                            style="color: red; font-size: 16px;">* </span>ইমেইল</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="des" id="des" class="form-control"
                                               onblur="check_text_field('des','des_err')" required>
                        ...
                        <div class="col-md-6">
                            <div class="accordion-box triggerAnimation animated" data-animate="fadeInLeft">
                                <div class="row" style="margin-right: 5px;">
                                    <div class="form-group">
                                        <label for="idea_title"><span
                                            style="color: red; font-size: 16px;">* </span>বিষয়</label>
                                    ...
                                    <div class="form-group">
                                        <label for="idea_issue"><span
                                            style="color: red; font-size: 16px;">* </span>আপনার মতামত</label>
            ...
            <div style="text-align: center">
                <button class="btn btn-info" style="background-color: #8bc541; height: 50px;">মতামত নিবন্ধন করুন</button>
            </div>
        </form>
    </div>
    <!-- tempcore line -->
