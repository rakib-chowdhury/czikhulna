...
<div id="container">
    ...
    <div id="content">
        ...
        <h1 class="page-title about-title"><span style="background: #8bc541; color: whitesmoke;">কোর্স মূল্যায়ন</span>
        </h1>
        ...
        <div class="members-section" style="padding-top: 30px !important;">
            <div class="title-section">
                <div class="container triggerAnimation animated" data-animate="bounceIn">
                    <h2 style="font-weight: 900;"><?= $courseDtls[0]['c_name'] ?> মূল্যায়ন</h2>
                    <!--<p><span style="font-weight: 600">প্রশিক্ষণার্থীর নাম : </span><?= $userDtls[0]['name'] ?></p>
                    <p><span style="font-weight: 600">প্রশিক্ষণার্থীর জাতীয় পরিচয়পত্র নং : </span><?= $userDtls[0]['nid'] ?></p>-->
                </div>
            </div>
            <div class="container triggerAnimation animated" data-animate="fadeInUp">
                <div class="row">
                    <div class="col-xs-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3"
                        ...
                        <form onsubmit="return check()" action="<?= site_url('home/web_reviews_post') ?>" method="post" id="review_form">
                            ...
                            <div class="form-group">
                                <label for="" class="control-labe"
                                       style="text-align: left; padding-top: 5px;">কোর্সটি আরো ফলপ্রসূ করার ক্ষেত্রে আপনার পরামর্শ
                                    লিপিবদ্ধ করুন</label>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">কোর্স মূল্যায়ন</h4>
      </div>
