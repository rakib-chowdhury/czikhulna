            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-hover ">
                        ...
                        ?>
                        <hr>
                        <form action="<?php echo site_url('admin/edit_notice_post'); ?>" method="post">
                            <input type="hidden" name="notice_id" value="<?= $notice_info[0]['notice_id']?>">
                            <div class="">
                                <div class="row">
                                    <div class="form-group col-md-10 col-md-offset-1">
                                        ...
                                        <div class="col-md-11">
                                            <input type="text" name="notice_title" id="notice_title" class="form-control" value="<?= $notice_info[0]['notice_title'] ?>">
                                    ...
                                    <div class="form-group col-md-10 col-md-offset-1">
                                        ...
                                        <div class="col-md-11">
                                            <textarea name="notice_details" id="notice_details" class="summernote"><?= $notice_info[0]['notice_details']?></textarea>
                                            <span style="color: red;" id="notice_details_err"></span>
                                        </div>
                                    </div>

                                    <div class="form-group col-md-10 col-md-offset-1" style="text-align: center">
                                        <button type="submit" class="btn btn-success btn-raised">সংশোধন করুন</button>
                                    </div>
                                </div>
                            </div>
                        </form>
