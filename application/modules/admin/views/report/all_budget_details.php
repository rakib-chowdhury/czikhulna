                            ...
                            <div class="panel panel-body">
                                <table
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;"> ব্যয় লক্ষ্যমাত্রা</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="cursor: pointer"
                                                   onclick="get_course_amount(<?= $c['id'] ?>)"><?= str_replace(range(0, 9), $bn_digits, $c[0]) ?>
                                                    টাকা</a></td>
                                            <td><?= str_replace(range(0, 9), $bn_digits, $c['total_donation'] - $c[0]) ?>
                                                টাকা
                                            </td>
                                        </tr>
                                    <?php }
...
<div class="modal fade" id="course_modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"></button>
                <h4 style="text-align: center; font-weight: 700" class="modal-title">ব্যয় লক্ষ্যমাত্রা বিবরণ</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <table class="table-responsive" width="100%" style="margin-bottom: 30px;">
...
<script>
    ...
    function get_course_amount(donor_id) {
        $.ajax({
            type: 'post',
            url: '<?php echo site_url('admin/get_course_info');?>',
            data: {
                id: donor_id
            }, success: function (data) {
                console.log(data);
