            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-hover ">
                        <h2 style="text-align:center">অফিস সংশোধন</h2>
                        <hr>
                        <!---onsubmit="return online_reg()"---->
                        <form class="form-horizontal"  method="post"
                              action="<?php echo site_url('admin/edit_office_post'); ?>">
                            <input type="hidden" name="ofc_id" value="<?= $ofc[0]['inst_id']?>">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="col-md-12">
                                            <select name="trainee_class" id="trainee_class" class="form-control">
                                                ...
                                                foreach ($trainee_class as $e) { ?>
                                                    <option <?php if($ofc[0]['classification_id']==$e['id']){ echo 'selected'; } ?> value="<?= $e['id'] ?>"><?= $e['class_name'] ?></option>
                                                <?php }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-6 govt" style="text-align:; margin-bottom: 5px;">
                                        ...
                                        <select name="ofc_name" id="ofc_name" class="form-control">
                                            <option <?php if($ofc[0]['inst_name']=='উপজেলা সমবায় কার্যালয়'){ echo 'selected'; } ?> value="উপজেলা সমবায় কার্যালয়">উপজেলা সমবায় কার্যালয়</option>
                                            <option <?php if($ofc[0]['inst_name']=='জেলা সমবায় কার্যালয়'){ echo 'selected'; } ?> value="জেলা সমবায় কার্যালয়">জেলা সমবায় কার্যালয়</option>
                                            <option <?php if($ofc[0]['inst_name']=='বিভাগীয় সমবায় কার্যালয়'){ echo 'selected'; } ?> value="বিভাগীয় সমবায় কার্যালয়">বিভাগীয় সমবায় কার্যালয়</option>
                                            <option <?php if($ofc[0]['inst_name']=='সমবায় অধিদপ্তর'){ echo 'selected'; } ?> value="সমবায় অধিদপ্তর">সমবায় অধিদপ্তর</option>
                                            <option <?php if($ofc[0]['inst_name']=='আঞ্চলিক সমবায় ইন্সটিটিউট'){ echo 'selected'; } ?> value="আঞ্চলিক সমবায় ইন্সটিটিউট">আঞ্চলিক সমবায় ইন্সটিটিউট</option>
                                            <option <?php if($ofc[0]['inst_name']=='বাংলাদেশ সমবায় একাডেমী'){ echo 'selected'; } ?> value="বাংলাদেশ সমবায় একাডেমী">বাংলাদেশ সমবায় একাডেমী</option>
                                            <option <?php if($ofc[0]['inst_name']=='জেলা প্রশাসকের কার্যালয়'){ echo 'selected'; } ?> value="জেলা প্রশাসকের কার্যালয়">জেলা প্রশাসকের কার্যালয়</option>

                                            <option <?php if($ofc[0]['inst_name']=='উপজেলা নির্বাহী কর্মকর্তার কার্যালয়'){ echo 'selected'; } ?> value="উপজেলা নির্বাহী কর্মকর্তার কার্যালয়">উপজেলা নির্বাহী কর্মকর্তার কার্যালয়</option>

                                            <option <?php if($ofc[0]['inst_name']=='অন্যান্য'){ echo 'selected'; } ?> value="অন্যান্য">অন্যান্য</option>
                                    ...
                                    <div class="col-md-6 somitee" style="text-align: ; margin-bottom: 5px;">
                                        ...
                                        <input type="text" name="somitee_name" id="somitee_name"
                                               class="form-control" value="<?= $ofc[0]['inst_name']?>" >
                                    ...
                                    <div class="col-md-6 somitee" style="text-align: ; margin-bottom: 5px;">
                                        ...
                                        <input readonly type="text" name="reg_date" id="reg_date"
                                               class="form-control" value="<?= $ofc[0]['inst_reg_date']?>" >
                                    ...
                                    <div class="col-md-6 somitee" style="text-align: ; margin-bottom: 5px;">
                                        ...
                                        <input type="text" name="reg_update_num" id="reg_update_num"
                                               class="form-control" value="<?= $ofc[0]['inst_last_update_reg_number']?>" >
                                    ...
                                    <div class="col-md-6 somitee" style="text-align: ; margin-bottom: 5px;">
                                        ...
                                        <input readonly type="text" name="reg_update_date" id="reg_update_date"
                                               class="form-control" value="<?= $ofc[0]['inst_last_update_date']?>" >
                                    ...
                                    <div class="col-md-6 ofc-class" style="text-align: ;  margin-bottom: 5px;">
                                        ...
                                        <select name="ofc_div" id="ofc_div" class="form-control">
                                            ...
                                            foreach ($division as $d) { ?>
                                                <option <?php if($ofc[0]['inst_div_id']==$d['div_id']){ echo 'selected';} ?>
                                    ...
                                    <div class="col-md-6 ofc-class" style="text-align: ;  margin-bottom: 5px;">
                                        ...
                                        <select name="ofc_dist" id="ofc_dist" class="form-control">
                                            <?php
                                            foreach ($dist as $d) { ?>
                                                <option  <?php if($ofc[0]['inst_dist_id']==$d['dist_id']){ echo 'selected';} ?>
                                    ...
                                    <div class="col-md-6 ofc-class" style="text-align: ;  margin-bottom: 5px;">
                                        ...
                                        <select name="ofc_upz" id="ofc_upz" class="form-control">
                                            <?php
                                            foreach ($upz as $d) { ?>
                                                <option  <?php if($ofc[0]['inst_upz_id']==$d['upz_id']){ echo 'selected';} ?>
