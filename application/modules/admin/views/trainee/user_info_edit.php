                    ...
                    <div class="panel panel-hover ">
                        ...
                        <?php if (sizeof($user_info) == 0) {
                            ...
                            <form class="form-horizontal" onsubmit="return online_reg()" method="post"
                                  action="<?php echo site_url('admin/user_info_edit_post'); ?>" >
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="name_bng" class="form-control"
                                                       placeholder="প্রশিক্ষণার্থীর নাম" id="name_bng"
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="name_eng" class="form-control"
                                                       placeholder="প্রশিক্ষণার্থীর নাম" id="name_eng"
                                                       value="<?= $user_info[0]['name_eng']; ?>"
                                                       >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <?php
                                                if($user_info[0]['dob']==null || $user_info[0]['dob']==''){
                                                      $dobDa='';
                                                }else{
                                                      $dobD=explode('-',$user_info[0]['dob']);
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="radio" name="gender" value='1' <?php if($user_info[0]['gender']==1){ echo 'checked'; }?>  class="" required>পুরুষ
                                                &nbsp;&nbsp;
                                                <input type="radio" name="gender" value='2' <?php if($user_info[0]['gender']==2){ echo 'checked'; }?> class="" required>নারী
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="father_name" id="father_name"
                                                       class="form-control" value="<?= $user_info[0]['father_name']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="mother_name" id="mother_name"
                                                       class="form-control" value="<?= $user_info[0]['mother_name']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="spouse_name" id="spouse_name"
                                                       class="form-control" value="<?= $user_info[0]['spouse_name']?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-4" style="text-align:; margin-bottom: 5px;">
                                                    ...
                                                    <select name="p_div" id="p_div" class="form-control" required>
                                                        ...
                                                        foreach ($division as $d) { ?>
                                                            <option <?php if($user_info[0]['per_div_id']==$d['div_id']){ echo 'selected'; }?>
                                                ...
                                                <div class="col-md-4" style="text-align: ;  margin-bottom: 5px;">
                                                    ...
                                                    <select name="p_dist" id="p_dist" class="form-control" required>
                                                        <?php
                                                        foreach ($dist as $d) { ?>
                                                            <option <?php if($user_info[0]['per_dist_id']==$d['dist_id']){ echo 'selected'; }?>
                                                ...
                                                <div class="col-md-4" style="text-align: ;  margin-bottom: 5px;">
                                                    ...
                                                    <select name="p_upz" id="p_upz" class="form-control" required>
                                                        <?php
                                                        foreach ($upz as $d) { ?>
                                                            <option <?php if($user_info[0]['per_upz_id']==$d['upz_id']){ echo 'selected'; }?>
                                                ...
                                                <div class="col-md-10" style="text-align: ;  margin-bottom: 5px;">
                                                    ...
                                                    <input type="text" class="form-control" name="p_details"
                                                           id="p_details" required value="<?= $user_info[0]['parmanent_address']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="curr_add" id="curr_add" class="form-control"
                                                       required value="<?= $user_info[0]['present_address']?>">
                                            ...
                                            <div class="col-md-12">
                                                <select name="blood_grp" id="blood_grp" class="form-control">
                                                    ...
                                                    foreach ($blood_grp as $b) { ?>
                                                        <option <?php if($user_info[0]['blood_grp_id']==$b['blood_grp_id']){ echo 'selected';}?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="per_mb" id="per_mb" minlength="11"
                                                       maxlength="11" value="<?= str_replace(range(0,9),$bn_digits,$user_info[0]['mobile'])?>"
                                                       class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="imp_mb" id="imp_mb" maxlength="11"
                                                       minlength="11" value="<?= str_replace(range(0,9),$bn_digits,$user_info[0]['other_mb'])?>"
                                                       class="form-control" >
                                                <span style="color: peru">১১ডিজিট(০১*********)</span>
                                                <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="email" name="trainee_email" id="trainee_email"
                                                       class="form-control" value="<?= $user_info[0]['email']?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="trainee_fb" id="trainee_fb"
                                                       class="form-control" value="<?= str_replace(range(0,9),$bn_digits,$user_info[0]['fb_link'])?>">
                                            ...
                                            <div class="col-md-12">
                                                <select name="education" id="education" class="form-control" required>
                                                    ...
                                                    foreach ($education as $e) { ?>
                                                        <option <?php if($user_info[0]['edu_id']==$e['edu_id']){ echo 'selected';}?>
                                            ...
                                            <div class="col-md-12">
                                                <select name="trainee_class" id="trainee_class" class="form-control">
                                                    ...
                                                    foreach ($trainee_class as $e) { ?>
                                                        <option <?php if($user_info[0]['classification_id']==$e['id']){ echo 'selected';}?> value="<?= $e['id'] ?>"><?= $e['class_name'] ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <select name="des" id="des" class="form-control">
                                                    <?php
                                                    foreach ($des as $e) { ?>
                                                        <option <?php if($user_info[0]['designation_id']==$e['des_id']){ echo 'selected';}?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <select name="ofc_id" id="ofc_id" class="form-control ofc-nrml"
                                                    ...
                                                    <?php   
                                                    foreach ($inst as $e) { ?>                                                        
                                                        <option <?php if($user_info[0]['office_id']==$e['inst_id']){ echo 'selected';}?>
