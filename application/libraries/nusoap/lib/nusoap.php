	...
	function invoke_method() {
		...
		if ($this->wsdl) {
			if ($this->opData = $this->wsdl->getOperationData($this->methodname)) {
				...
				// Note: hopefully this case will only be used for admin/lit, since rpc services should have wrapper element
...
class nusoap_client extends nusoap_base  {
	...
	*/
	 ...
	 */
	function loadWSDL() {
		$this->debug('instantiating wsdl class with admin: '.$this->wsdlFile);
