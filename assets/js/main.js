...
$(document).ready(function () {
    ...
    // $('.datepick_class').datepicker({
    // 	autoclose:true
    // });
    // $('body').on('focus',".datepick_class", function(){
    // 	$(this).datepicker();
    // });​
    $(document).on('focus', ".datepick_class", function () {
        $(this).datepicker({
            autoclose: true
        });
    });
    ...
    $('#donation_date1').datepicker({
        autoclose: true
    });
    $('#donation_date2').datepicker({
        autoclose: true
    });
    ...
    $('input[name=pre_prog_date]').datepicker();
